 ...
 */
public class FloorGLSurfaceView  extends GLSurfaceView {

        private final FloorGLRenderer mRenderer;

        public FloorGLSurfaceView(Context context) {
            super(context);
            ...
            mRenderer = new FloorGLRenderer(context);
